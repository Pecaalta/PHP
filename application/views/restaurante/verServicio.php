<style>
    ...
    .star[date-satar="5"] .active::before {
        content: '\f005 \f005 \f005 \f005 \f005';
    }

    .star[date-satar="4"] .active::before {
        content: '\f005 \f005 \f005 \f005';
    }

    .star[date-satar="4"] .inactive::before {
        content: '\f005';
    }

    .star[date-satar="3"] .active::before {
        content: '\f005 \f005 \f005';
    }

    .star[date-satar="3"] .inactive::before {
        content: '\f005 \f005';
    }

    .star[date-satar="2"] .active::before {
        content: '\f005 \f005';
    }

    .star[date-satar="2"] .inactive::before {
        content: '\f005 \f005 \f005';
    }

    .star[date-satar="1"] .active::before {
        content: '\f005';
    }

    .star[date-satar="1"] .inactive::before {
        content: '\f005 \f005 \f005 \f005';
    }

    .star[date-satar="0"] .inactive::before {
        content: '\f005 \f005 \f005 \f005 \f005';
    }
            ...
            <div class="row p-15">
                <div class="col-lg-5 col-xl-4">
                    <div class="view overlay rounded z-depth-1-half mb-lg-0 mb-4">
                        <img data-toggle="modal" data-target="#imgModal" onerror="javascript:imgError(this)" onclick="imgaengrande.src = <?php echo base_url($item->imagen); ?>" class="img-fluid" src="<?php echo base_url($item->imagen); ?>">
