            ...
            <li class="nav-item avatar dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg-right dropdown-secondary" aria-labelledby="navbarDropdownMenuLink-55">
                    <?php if (isset($id) and !isset($rut)):?>
                        ...
                        <a class="dropdown-item" href="<?php echo base_url().'reserva/mis_reservas/'.$id; ?>">Mis reservas</a>
                        <a class="dropdown-item" href="<?php echo base_url().'servicio/comentar_servicio/'.$id; ?>">Servicios Reservados</a>
                    <?php endif;?>
                    <?php if (isset($rut)):?>
